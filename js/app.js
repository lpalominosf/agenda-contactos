$(document).ready(function(){
	...
	*/
	...
	/*
	*Evento click que se ejecuta cuando le hago click al botón de id add
	...
	*/
	...
	$('#add').click(function(){
		...
		*/
		...
		/*
		*Guardo en la variable contenedor el div con id cont que está
		*en el html, donde se guardarán los contactos
		*/
		var contenedor = $('#cont');
		/*
		*Le agrego al contenedor la estructura que necesito con el calor de 
	...
	*/
	function deleteContact(){
		/*
		*Esta función se ejecuta una vez que se le da click al icono de la basura
		*/
	...
	*/
	$('#search').keyup(function(){
		/*
		* Guardo en la variable nombre de lo que se ingresó en el input
		*/
		var nombre = $(this).val();
		/*
		...
		*/
		$('.collection').hide();
		/*
		* Itero por cada uno de los contactos que están contenidos en un ul
